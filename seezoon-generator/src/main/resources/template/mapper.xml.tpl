...
<mapper namespace="com.seezoon.dao.modules.${moduleName}.${className}Dao">
    ...
    <#assign firstItem = true>
    <#list columnPlans as columnPlan><#if columnPlan.blobType>${firstItem?string("",",")}${defaultTableAliasPrefix}${columnPlan.javaFieldName}<#assign firstItem = false></#if></#if></#list>
    </sql>
    </#if>
    <sql id="Query_Table" >
    ...
    <select id="selectByCondition" parameterType="com.seezoon.dao.modules.${moduleName}.entity.${className}Condition"
