    ...
    >
      ...
      >
        <a-tab-pane key="tab1" tab="账号密码登录">
          <a-alert v-if="isLoginError" message="账户或密码错误（admin/ant.design )" showIcon style="margin-bottom: 24px;"
                   type="error"/>
          <a-form-item>
            <a-input
              v-decorator="[
                'username',
                {rules: [{ required: true, message: '登录账号' }, { validator: handleUsernameOrEmail }], validateTrigger: 'change'}
              ]"
              placeholder="账号"
              size="large"
              type="text"
      ...
      <div class="user-login-other">
        ...
        <router-link :to="{ name: 'register' }" class="register">注册账户</router-link>
      </div>
    </a-form>
