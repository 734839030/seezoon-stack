      ...
      <a-row>
        <a-col :md="12" :xs="24">
          <a-form-item label="联系人" name="contactUser">
            <a-input v-model:value="dataForm.contactUser" :maxlength="50" placeholder="联系人"></a-input>
          </a-form-item>
        </a-col>
        <a-col :md="12" :xs="24">
          <a-form-item label="联系电话" name="telephone">
            <a-input v-model:value="dataForm.telephone" :maxlength="50" placeholder="联系电话"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
