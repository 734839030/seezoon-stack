...
# for jdk version >= 11
JAVA_OPTS="-Xmx512m -Xms128m -XX:+UseG1GC -verbose:gc -Xlog:gc*,safepoint:./logs/gc/gc.log:time,uptime:filecount=10,filesize=10M -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=./logs/dump"
